...
{
	public partial class JoinSessionDialog
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget BangSharp.Client.JoinSessionDialog
			this.Name = "BangSharp.Client.JoinSessionDialog";
			this.Title = global::Mono.Unix.Catalog.GetString ("Join Session");
			this.TypeHint = ((global::Gdk.WindowTypeHint)(1));
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			this.Modal = true;
			this.DestroyWithParent = true;
			// Internal child BangSharp.Client.JoinSessionDialog.VBox
			...
			this.vbox14.Add (this.playerDataWidget);
			global::Gtk.Box.BoxChild w2 = ((global::Gtk.Box.BoxChild)(this.vbox14 [this.playerDataWidget]));
			w2.Position = 0;
			w2.Expand = false;
			w2.Fill = false;
			// Container child vbox14.Gtk.Box+BoxChild
			...
			this.vbox14.Add (this.frame7);
			global::Gtk.Box.BoxChild w7 = ((global::Gtk.Box.BoxChild)(this.vbox14 [this.frame7]));
			w7.Position = 1;
			w7.Expand = false;
			w7.Fill = false;
			w1.Add (this.vbox14);
			global::Gtk.Box.BoxChild w8 = ((global::Gtk.Box.BoxChild)(w1 [this.vbox14]));
			w8.Position = 0;
			w8.Expand = false;
			w8.Fill = false;
			// Internal child BangSharp.Client.JoinSessionDialog.ActionArea
